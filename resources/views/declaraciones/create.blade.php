    ...
    <div class="bg-white shadow-sm border border-gray-200 rounded-lg overflow-hidden">
        ...
        <form action="{{ route('declaraciones.store') }}" method="POST" id="declaracionForm" class="p-2 sm:p-4 md:p-8">
            ...
            <div class="mb-8">
                ...
                <!-- ...otras instituciones... -->
            <!-- ...otras instituciones... -->
            </div> <!-- cierre de instituciones externas -->
            <!-- ...otras instituciones... -->
            </div> <!-- cierre de instituciones externas -->

            <!-- cierre de instituciones externas -->
            </div>

            <!-- Observaciones adicionales solo después del panel de instituciones externas -->
            ...
            <div class="mb-8">
                ...
                <textarea name="observaciones_adicionales" id="observaciones_adicionales" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors bg-gray-50" placeholder="Ingrese observaciones adicionales aquí..."></textarea>
            </div>
