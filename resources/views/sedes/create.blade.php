...
<div class="max-w-4xl mx-auto px-4 py-8">
    <div class="bg-white shadow-sm border border-gray-200 rounded-lg overflow-hidden">
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6">
            <h2 class="text-2xl font-semibold text-white">Registrar Sede</h2>
            <p class="text-blue-100 text-sm mt-1">Complete la información de la nueva sede</p>
        </div>

        <form method="POST" action="{{ route('sedes.store') }}" class="p-8">
            @csrf
            <div class="space-y-6">
                <div>
