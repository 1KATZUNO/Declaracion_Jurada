    ...
    <div class="bg-white shadow-sm border border-gray-200 rounded-lg overflow-hidden">
        <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-blue-100 text-sm mt-1">Gestión de cargos y jornadas</p>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="py-3 px-4 text-left text-xs font-medium text-gray-700 uppercase tracking-wider">Jornada</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="py-4 px-4 text-sm text-gray-600">{{ $c->jornada ?? '—' }}</td>
                            <td class="py-4 px-4 text-sm text-gray-600">{{ Str::limit($c->descripcion, 60) }}</td>
